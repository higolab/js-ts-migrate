...
for entry in type_changes:
	...
	orig != new  # 順序が異なる
		...
		union_type_order_changed.append({
			"file": entry["file"],
			"name": entry["name"],
			"original_type": orig,
			"migrated_type": new
...
result = {
	"summary": {
		...
		"function_type_changed": len(function_type_changes),
		...
		"to_generic_type": len(generic_type_changes),
		"object_property_type_changed": len(object_property_type_changes),
		"named_type_to_object_literal_changed": len(named_type_to_object_literal_changes),
		"union_type_order_changed": len(union_type_order_changed),
		"generic_type_arguments_removed": len(generic_type_arguments_removed),
		"to_object_literal": len(to_object_literal),
	...
	"union_type_order_changed": union_type_order_changed,
	"generic_type_arguments_removed": generic_type_arguments_removed,
	"to_object_literal": to_object_literal,
